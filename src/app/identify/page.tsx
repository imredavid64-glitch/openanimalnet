      ...
      <main className="container mx-auto px-4 py-20">
        <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
          ...
          <p className="text-xl text-secondary-600 dark:text-secondary-400 max-w-2xl mx-auto">
            Upload a photo of any animal and our AI will identify the species from our database of 42+ verified species.
          </p>
        </motion.div>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <Link href={`/animal/${r.species?.toLowerCase().replace(/\s+/g, '-')}`}
