...
export const sampleAnimals: Animal[] = [
  ...
  },
  {
    ...
    livestockTelemetry: {
      herdSize: 120,
      averageRuminationMinutes: 480,
      averageBodyTemperature: 38.6,
      averageMobilityScore: 85,
      healthAlerts: 2,
      recentMetrics: [
        { timestamp: new Date('2026-08-13T06:00'), rumination: 52, temperature: 38.4, mobility: 88 },
        { timestamp: new Date('2026-08-13T08:00'), rumination: 48, temperature: 38.6, mobility: 86 },
        { timestamp: new Date('2026-08-13T10:00'), rumination: 45, temperature: 39.1, mobility: 72 },
        { timestamp: new Date('2026-08-13T12:00'), rumination: 38, temperature: 39.4, mobility: 65 },
        { timestamp: new Date('2026-08-13T14:00'), rumination: 35, temperature: 39.8, mobility: 58 },
        { timestamp: new Date('2026-08-13T16:00'), rumination: 40, temperature: 39.5, mobility: 62 },
        { timestamp: new Date('2026-08-13T18:00'), rumination: 46, temperature: 38.9, mobility: 75 },
        { timestamp: new Date('2026-08-13T20:00'), rumination: 50, temperature: 38.5, mobility: 82 },
        { timestamp: new Date('2026-08-14T06:00'), rumination: 51, temperature: 38.3, mobility: 87 },
        { timestamp: new Date('2026-08-14T08:00'), rumination: 49, temperature: 38.5, mobility: 85 },
        { timestamp: new Date('2026-08-14T10:00'), rumination: 47, temperature: 38.7, mobility: 80 },
        { timestamp: new Date('2026-08-14T12:00'), rumination: 44, temperature: 39.0, mobility: 74 },
      ],
      diseaseRisks: [
        { name: 'Mastitis', risk: 'moderate', indicator: 'Elevated temperature 39.4-39.8C at midday', probability: 0.35 },
        { name: 'Lameness', risk: 'low', indicator: 'Mobility score dipped to 58 but recovering', probability: 0.12 },
        { name: 'Heat Stress', risk: 'low', indicator: 'Rumination normal at 480 min/day average', probability: 0.08 },
      ],
    },
  },
  {
